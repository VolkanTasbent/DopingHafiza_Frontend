...
function createAiCoachStyles(a) {
  return StyleSheet.create({
    container: { flex: 1, backgroundColor: a.pageBg, padding: 16 },
    ...
    ghostNavBtnText: { color: a.ghostText, fontWeight: "700", fontSize: 15 },
    heroCard: {
      marginBottom: 10,
      backgroundColor: a.heroSolid,
      borderColor: a.heroBorder,
      borderWidth: 1,
      borderRadius: 16,
      shadowColor: a.heroShadow,
    ...
    heroSub: { color: a.heroTextMuted, fontSize: 12, marginBottom: 10 },
    metricsRow: { flexDirection: "row", gap: 8 },
    metricPill: {
      flex: 1,
      borderRadius: 12,
      backgroundColor: a.heroPillBg,
      borderWidth: 1,
      borderColor: a.heroPillBorder,
      paddingVertical: 8,
      paddingHorizontal: 10,
    },
    metricLabel: { color: a.heroTextMuted, fontSize: 11, fontWeight: "600" },
    metricValue: { color: "#fff", fontSize: 13, fontWeight: "800", marginTop: 1 },
    h2: { color: a.text, fontWeight: "800", marginBottom: 6 },
    hint: { color: a.muted, fontSize: 12, marginBottom: 8 },
    ...
    presetChipText: { color: a.chipText, fontWeight: "700", fontSize: 12 },
    thread: { marginBottom: 10 },
    bubble: { maxWidth: "92%", padding: 12, borderRadius: 14, marginBottom: 8 },
    bubbleUser: { alignSelf: "flex-end", backgroundColor: a.bubbleUser },
    bubbleAssistant: { alignSelf: "flex-start", backgroundColor: a.bubbleAsstBg, borderWidth: 1, borderColor: a.bubbleAsstBorder },
    bubbleUserText: { color: "#fff", fontSize: 14, lineHeight: 20 },
    bubbleAssistantText: { color: a.text, fontSize: 14, lineHeight: 20 },
    input: {
    ...
    quickLabel: { fontSize: 11, fontWeight: "700", color: a.muted, marginBottom: 6 },
    quickChip: {
      backgroundColor: a.quickChipBg,
      paddingHorizontal: 10,
      paddingVertical: 6,
      borderRadius: 999,
      borderWidth: 1,
      borderColor: a.quickChipBorder,
    },
    quickChipText: { color: a.chipText, fontSize: 11, fontWeight: "600" },
    savedBlock: {
      borderWidth: 1,
      borderColor: a.border,
      borderRadius: 12,
    ...
    savedTitle: { fontWeight: "800", color: a.text, flex: 1 },
    savedDate: { color: a.muted, fontSize: 11, marginBottom: 6 },
    savedTask: { color: a.muted, fontSize: 12, marginTop: 2 },
    deleteLink: { color: a.danger, fontWeight: "700", fontSize: 13 },
    planHead: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 6, gap: 8 },
    item: { borderBottomWidth: 1, borderBottomColor: a.border, paddingVertical: 10 },
    itemTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 },
    title: { color: a.text, fontWeight: "700" },
    riskBadge: {
      color: a.riskText,
    ...
    meta: { color: a.muted, fontSize: 12, marginTop: 2 },
    desc: { color: a.textBody, fontSize: 13, marginTop: 4 },
    muted: { color: a.muted, fontSize: 13 },
  });
}

export default function AiCoachScreen({ navigation }) {
  const { aiCoach } = useTheme();
  const styles = useMemo(() => createAiCoachStyles(aiCoach), [aiCoach]);
